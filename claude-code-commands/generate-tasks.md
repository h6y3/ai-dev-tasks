# /generate-tasks - AI Dev Tasks Workflow
**Source**: ai-dev-tasks repository workflow  
**Purpose**: Generate task list from existing PRD using two-phase approach  
**Previous Step**: Complete `/create-prd` first  
**Next Step**: Use `/process-tasks` to implement tasks

Please generate tasks from the PRD using the structured task generation workflow.
